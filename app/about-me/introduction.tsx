...
export default function Introduction() {
    return(
            <div className="px-[150px] py-[20px] h-[600px] justify-center inline-flex w-full">
                <div className="justify-between inline-flex w-full max-w-6xl border-solid border-2 border-red-600">
                    <div className="flex flex-row items-center w-fit h-fit border-solid border-2 border-green-600">
