...
export default function section() {
  return (
    <section id="summary" className="flex w-screen flex-col pb-24">
      <div className="mb-24 flex w-fit flex-col justify-center bg-rose-400 p-6 pl-16">
        <h2
          className={`font-bold ${inter.className} text-stone-50`}
        >{`Overview`}</h2>
      </div>
      <div className="flex w-full flex-col items-center justify-center px-16 md:flex-row">
