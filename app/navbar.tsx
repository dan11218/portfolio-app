...
export default function Navbar() {
  return (
    <div className="sticky top-0 flex w-screen flex-col items-center border-b-2 border-solid  border-slate-300 bg-slate-50 px-[20px] shadow-lg dark:border-none dark:bg-slate-800">
