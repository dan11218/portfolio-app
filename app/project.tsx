...
import { space_mono, albert_sans } from "./fonts";

export default function Project(props: any) {
  return (
    <Link
      href={props.project_url}
      className="group mb-8 mr-6 flex h-[520px] w-[450px] flex-col overflow-hidden rounded-md border-[0.5px] border-solid border-slate-400 pb-4 shadow-lg transition duration-300"
    >
      <Image
        src={props.image_url}
        width={500}
